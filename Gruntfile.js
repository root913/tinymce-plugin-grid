...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/tinymce-plugin-grid/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/tinymce-plugin-grid/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
        ...
        files: [
          {
            cwd: 'src/text',
            src: ['license.txt'],
            dest: 'dist/tinymce-plugin-grid',
            expand: true
          },
          { src: ['changelog.txt'], dest: 'dist/tinymce-plugin-grid', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/tinymce-plugin-grid/version.txt', BUILD_VERSION);
  });
